  ...
  render() {
    ...
    return (
      <Map
        ...
        ref={(e) => { this.map = e; }}
        onDragEnd={this.fetchRequests /* fired after panning, zooming, first load */}
        zoom={16}
      >
        {
